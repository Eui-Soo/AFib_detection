...
train_AF_tmp_set=train_AF_set
train_AF_tmp_set=(train_AF_tmp_set-1)*(-1)
train_AF_set=np.append(train_AF_set,train_AF_tmp_set,axis=0)
...
test_AF_tmp_set=test_AF_set
test_AF_tmp_set=(test_AF_tmp_set-1)*(-1)
test_AF_set=np.append(test_AF_set,test_AF_tmp_set,axis=0)
...
train_SR_tmp_set=train_SR_set
train_SR_tmp_set=(train_SR_tmp_set-1)*(-1)
train_SR_set=np.append(train_SR_set,train_SR_tmp_set,axis=0)        
...
test_SR_tmp_set=test_SR_set
test_SR_tmp_set=(test_SR_tmp_set-1)*(-1)
test_SR_set=np.append(test_SR_set,test_SR_tmp_set,axis=0)
os.chdir(root_path)
...
s='data_set_idx({0})_stride({1})_obtime_{2}s_filp'.format(test_idx, stride_time,ob_time)
